...
<script src="{{asset('home_ui/lib/owlcarousel/assets/lib/easing/easing.min.js')}}"></script>
<script src="{{asset('home_ui/lib/owlcarousel/assets/lib/waypoints/waypoints.min.js')}}"></script>
<script src="{{asset('home_ui/lib/owlcarousel/assets/lib/counterup/counterup.min.js')}}"></script>
<script src="{{asset('home_ui/lib/owlcarousel/assets/lib/owlcarousel/owl.carousel.min.js')}}"></script>
