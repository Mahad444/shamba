...
<body id="page-top">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Farmers laravel project @2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <!-- Page level plugins -->
  <script src="{{asset('admin_ui/vendor/chart.js/Chart.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{asset('admin_ui/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('admin_ui/js/demo/chart-pie-demo.js')}}"></script>
