    ...
    @section('content')
                ...
                <div class="row justify-content-start">
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <a href="" class="btn btn-primary py-md-3 px-md-5 me-3"
                            >Home</a
                        >
                        <a href="" class="btn btn-secondary py-md-3 px-md-5"
                            >Products</a
                        >
                    </div>
                </div>
                    ...
                    <div class="pb-5">
                        ...
                        >
                            <img
                                ...
                                src="{{asset('home_ui/img/product-1.png')}}"
                                alt=""
                            />
                            <h6 class="mb-3">Organic Vegetable</h6>
                            <h5 class="text-primary mb-0">$19.00</h5>
                            <div
                                class="btn-action d-flex justify-content-center"
                            >
        ...
        >
            <div class="container py-5 pb-lg-0">
                <div
                    class="mx-auto text-center mb-3 pb-2"
                ...
                <div class="row g-5">
                    <div class="col-lg-3">
                        <div class="text-white mb-5">
                            ...
                            <p class="mb-0">
                                Labore justo vero ipsum sit clita erat lorem
                                magna clita
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div
                            class="d-block bg-white h-100 text-center p-5 pb-lg-0"
                        >
                            <p>
                                At et justo elitr amet sea at. Magna et sit vero
                                at ipsum sit et dolores rebum. Magna sea eos sit
                                dolor, ipsum amet no tempor ipsum eirmod lorem
                                eirmod diam tempor dolor eos diam et et diam
                                dolor ea. Clita est rebum amet dolore sit. Dolor
                                stet dolor duo clita, vero dolor ipsum amet
                                dolore magna lorem erat stet sed vero dolor
                            </p>
                            <img
                                class="img-fluid"
                                src="{{asset('home_ui/img/feature.png')}}"
                                alt=""
                            />
                        </div>
                    </div>
